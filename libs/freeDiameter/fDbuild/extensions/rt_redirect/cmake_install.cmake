# Install script for directory: /root/dev/freeDiameter/extensions/rt_redirect
...
if("${CMAKE_INSTALL_COMPONENT}" STREQUAL "freeDiameter-daemon" OR NOT CMAKE_INSTALL_COMPONENT)
  ...
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/lib/freeDiameter" TYPE MODULE FILES "/root/dev/freeDiameter/fDbuild/extensions/rt_redirect.fdx")
  if(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/freeDiameter/rt_redirect.fdx" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/freeDiameter/rt_redirect.fdx")
